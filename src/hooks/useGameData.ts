...
export const useGameData = () => {
    ...
    const deleteGame = (gameId: string) => {
        ...
        if(gameToDelete) {
             setModalMessage({ show: true, title: 'Đã Xóa', content: `Game "${gameToDelete.settings?.theme || gameId}" đã được xóa.`, type: 'success' });
        }
    };
    ...
    return {
        ...
        savedGames, loadGame, deleteGame, setConfirmationModal, setModalMessage, modalMessage, confirmationModal, showSuggestionsModal,
